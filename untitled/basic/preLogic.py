...
while(1):
    ...
    if(choice==1):
        while (1):
            print('------------------PreDef Function LOGIC MENU-------------------')
            print('\n1:Factorial\n2:Square root\n3:Power\n4:Binary no\n5:Hexadecimal no\n6:Round off\n7:EXIT')
            ch1 = int(input('enter your choice'))

            if (ch1 == 1):
                num=int(input('enter a no '))
                print('Factorial is :'+str(math.factorial(num)))

            elif (ch1 == 2):
                num = int(input('enter a no '))
                print('Square root is :' + str(math.sqrt(num)))

            elif (ch1 == 3):
                num=int(input('enter a no'))
                p=int(input('enter power'))
                print(str(num)+' power '+str(p)+' is :'+str(math.pow(num,p)))

            elif (ch1 == 4):
                num = int(input('enter a no '))
                print('Binary equivalint is :' + str(bin(num)))

            elif (ch1 == 5):
                num = int(input('enter a no '))
                print('Hex equivalint is :',hex(num))
            ...
            con1 = int(input('Do You want to continue [PREDEFFUN-LOGIC]......Press 1...'))
            if (con1 != 1):
                break
